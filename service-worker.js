...
const CACHE_FILES = [
  ...
  './icons/icon-192.png',
  './icons/icon-512.png',
  // Google Fonts（オフライン用フォールバック）
  'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300&family=Noto+Sans+JP:wght@300;400;500&display=swap',
];
